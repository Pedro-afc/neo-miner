            ...
            <Card key={card.id} className="bg-gradient-to-br from-purple-800/50 to-blue-800/50 border-purple-500/30 p-4 rounded-2xl backdrop-blur-sm">
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <div className="p-2 rounded-lg bg-orange-500/30 shadow-lg">
                    <Icon className="w-5 h-5 text-orange-200 drop-shadow-lg" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-yellow-300 text-sm truncate drop-shadow-md">{card.name}</h3>
